        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{route('business')}}"><i class="fa fa-circle-o"></i> Registraton Processes </a></li>
              @if(App\Business::count() < 1)
              <li><a href="{{route('addProcesses')}}"><i class="fa fa-circle-o"></i>Add Registration Processes</a></li>
              @else
              <li><a href="{{route('editProcesses')}}"><i class="fa fa-circle-o"></i>Edit Registration Processes</a></li>
              @endif
            </ul>
          </li>
          {{--
