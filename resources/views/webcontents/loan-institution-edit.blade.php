            ...
            <form action="{{route('updateInstitution', ['id'=>$institution->id])}}" method="post">
                    ...
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control{{ $errors->has('organization_name') ? ' is-invalid' : '' }}" name="organization_name"
                                value="{{$institution->organization_name}}" required autofocus> @if($errors->has('organization_name'))
                    ...
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="collateral" class="form-control{{ $errors->has('collateral') ? ' is-invalid' : '' }}" name="collateral"
                                value="{{$institution->collateral}}" required autofocus> @if ($errors->has('collateral'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" step="any" id="credit_value" class="form-control{{ $errors->has('credit_value') ? ' is-invalid' : '' }}"
                                name="credit_value" value="{{$institution->credit_value}}" required autofocus>@if($errors->has('credit_value'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" step="any" id="minimum_amount" class="form-control{{ $errors->has('minimum_amount') ? ' is-invalid' : '' }}"
                                name="minimum_amount" value="{{$institution->minimum_amount}}" required autofocus>@if($errors->has('minimum_amount'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="scale" class="custom-select col-sm-10 form-control{{ $errors->has('scale') ? ' is-invalid' : '' }}" name="scale"
                                value="{{$institution->scale}}" required autofocus>
                    ...
                    <div class="row col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <textarea id="extra" rows="2" class="form-control{{ $errors->has('extra') ? ' is-invalid' : '' }}" name="extra" value="{{ old('extra') }}"
                                required autofocus>{{$institution->extra_notes}}</textarea> @if ($errors->has('extra'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="row col-sm-6 form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts" class="form-control{{ $errors->has('contacts') ? ' is-invalid' : '' }}" name="contacts" value="{{ $institution->contacts }}"
                ...
                <div align="center">
                    <input type="submit" class="btn btn-primary" value="Update Institution">
                </div>
            </form>
        </div>
    </div>
